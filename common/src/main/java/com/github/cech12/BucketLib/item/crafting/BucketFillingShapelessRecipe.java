package com.github.cech12.BucketLib.item.crafting;
...
import static com.github.cech12.BucketLib.item.InventoryUtils.getItemsInInventory;
...
public class BucketFillingShapelessRecipe extends ShapelessRecipe {
    ...
    public BucketFillingShapelessRecipe(ResourceLocation resourceLocation, String group, CraftingBookCategory category, NonNullList<Ingredient> ingredients, BucketFillingType fillingType, Optional<Fluid> fluid, Optional<Block> block, Optional<EntityType<?>> entityType) {
        super(resourceLocation, group, category,
    ...
    public static class Serializer implements RecipeSerializer<BucketFillingShapelessRecipe> {
        ...
        @Override
        public BucketFillingShapelessRecipe fromJson(ResourceLocation resourceLocation, JsonObject jsonObject) {
            return null;
        }

        @Override
        @Nonnull
        public BucketFillingShapelessRecipe fromNetwork(ResourceLocation resourceLocation, FriendlyByteBuf buf) {
            ...
            return new BucketFillingShapelessRecipe(resourceLocation, group, category, ingredients, fillingType, fluid, block, entityType);
        }
